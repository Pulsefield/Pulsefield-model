...
| Task | Resource |
| --- | --- |
| Agent Note or decision-record addition, supersession, retention, rejection, archival, restoration, or deletion | `.agents/skills/pulsf-archive-agent-notes/SKILL.md` |
