...
description: Manage Git-tracked Ensomi Agent Notes on the dedicated agent-notes branch. Use to create, update, review, accept, implement, reject, archive, restore, consolidate, or delete research, decision, investigation, implementation, simplification, and process records that must persist across agent turns. Keep notes out of product branches and route durable product contracts to their owning code, configuration, tests, or curated documentation.
---

# Manage Ensomi Agent Notes
