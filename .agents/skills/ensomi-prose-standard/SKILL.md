...
description: Use when writing, reviewing, trimming, restoring, or auditing Ensomi prose for technical completeness, precision, placement, and readability across docs, skills, comments, diagnostics, prompts, protocol text, and CLI strings. Route authoring-session and reasoning-transcript leakage audits to ensomi-trim-cot-leakage.
---
...
Use this skill for editorial judgment and required prose coverage. Follow [`documentation_authoring.md`](../../../docs/guides/documentation_authoring.md) for repository Markdown syntax and rendering conventions. Use [`ensomi-trim-cot-leakage`](../ensomi-trim-cot-leakage/SKILL.md) for authoring-session leakage. Use [`technical_analysis_writing.md`](../../../docs/guides/technical_analysis_writing.md) for root-cause analyses, performance investigations, and postmortems. Use [`hydra-conventions`](../hydra-conventions/SKILL.md) for Hydra ownership or projection, [`research-triage`](../research-triage/SKILL.md) for research direction and evaluation, and [`ensomi-archive-agent-notes`](../ensomi-archive-agent-notes/SKILL.md) for Agent Note content and lifecycle on the separate `agent-notes` branch.
...
## Respect Ensomi source boundaries
...
- Use `ref-proj/` only when comparison is explicitly in scope, and describe it as reference evidence rather than Ensomi authority.
