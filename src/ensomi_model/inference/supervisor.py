...
from ensomi_model.inference.model_bundles.base import ModelBundle, ModelBundleSnapshot
from ensomi_model.inference.model_bundles.registry import ModelBundleRegistry
