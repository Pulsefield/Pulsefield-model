...
from ensomi.protocol.v1 import core_pb2, envelope_pb2, inference_pb2

from ensomi_model.inference.errors import ProtocolError
...
MODEL_SERVICE_NODE_ID = "ensomi-model.inference"
MODEL_SERVICE_APP_ID = "ensomi.model"

try:
    PROTOCOL_VERSION = version("ensomi-protocol")
