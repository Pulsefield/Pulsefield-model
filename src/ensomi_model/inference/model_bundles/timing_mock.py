...
from ensomi_model.inference.model_bundles.base import ModelBundle, RouteBackend
from ensomi_model.inference.service_models import InferenceRoute
from ensomi_model.inference.stream_with_cache import DecoderWindow, HitObjectToken, StreamWithCacheConfig
...
def _default_timing_fit_fn(*args: object, **kwargs: object) -> dict[str, object]:
    from ensomi_model.timing.fit_audio import fit_audio_file
