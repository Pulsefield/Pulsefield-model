...
from ensomi_model.events.canonical import (
    CanonicalTimepoint,
    LaneAction as CanonicalLaneAction,
)
from ensomi_model.osu_core.export import format_hitobjects
from ensomi_model.models.mapper.shared.generation import transition_carry_state
from ensomi_model.models.mapper.shared.replay import LNCarryState
from ensomi_model.models.mapper.shared.vocab import (
    KEY_COUNT,
...
class OsuExportMetadata:
    ...
    title: str = "Ensomi Mapper Stream"
