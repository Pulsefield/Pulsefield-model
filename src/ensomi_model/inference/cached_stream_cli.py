...
from ensomi_model.events.canonical import CanonicalTimepoint, LaneAction as CanonicalLaneAction
...
from ensomi_model.inference.osu_export import OsuExportMetadata, format_osu_export
from ensomi_model.inference.session_runtime import SessionRuntime, SessionRuntimeConfig
from ensomi_model.inference.stream_windows import DecoderWindow, decoder_windows_until_audio_end
...
from ensomi_model.timing.providers.beatthis import DEFAULT_BEATTHIS_DEVICE
...
def run_candidate(
    *,
    ...
    from ensomi_model.inference.stream_with_cache import _grid_fitter_config_for_canonicalization
