...
from ensomi_model.inference.audio_probe import audio_length_ms_from_file
...
from ensomi_model.inference.mapper_v2_tuple_rollout import (
...
from ensomi_model.inference.model_runtime import (
    ModelRuntime,
    ModelRuntimeConfig,
    load_model_runtime,
    release_torch_cache,
)
from ensomi_model.inference.session_runtime import (
    DEFAULT_MAX_CONTROL_BATCH_SIZE,
    SessionRuntime,
    SessionRuntimeConfig,
)
from ensomi_model.inference.stream_windows import (
    DecoderWindow,
...
from ensomi_model.models.mapper.shared.tokenizer import MAPPER_WRITE_MS
from ensomi_model.models.mapper.v2_1.replay import empty_ln_carry_state as empty_ln_carry_state_v2_1
from ensomi_model.timing.canonicalization import TIMING_CANONICALIZATION_NONE
from ensomi_model.timing.grid_fitting import GridFitterConfig
from ensomi_model.timing.providers.beatthis import DEFAULT_BEATTHIS_CHECKPOINT, DEFAULT_BEATTHIS_DEVICE
...
class StreamWithCache:
    ...
    def _generate_window(
        ...
        if self._mapper_profile_name() == "v2_1_sparse":
            from ensomi_model.inference.model_bundles.mapper_v2_1_sparse import generate_window_v2_1_sparse

            return generate_window_v2_1_sparse(self, session_id, session_runtime, window, audio_length_ms)
        from ensomi_model.inference.model_bundles.mapper_v2_tuple import generate_window_v2_tuple
...
def run_cached_stream_sample(argv: Sequence[str] | None = None) -> int:
    from ensomi_model.inference.cached_stream_cli import run_cached_stream_sample as run_sample
