...
from ensomi_model.data.control_windows import TARGET_WINDOW_LENGTH_FRAMES
from ensomi_model.data.mapper_tuple_windows import control_teacher_stacked_slices_batch
from ensomi_model.features.mel import load_full_song_packed_mel_20ms
from ensomi_model.inference.model_runtime import ModelRuntime, release_torch_cache
from ensomi_model.models.control.context import TARGET_OFFSET_IN_CONTEXT
from ensomi_model.models.mapper.shared.tokenizer import MAPPER_DENSITY_FRAME_MS, MAPPER_DENSITY_FRAMES, MAPPER_WRITE_MS
from ensomi_model.timing.grid_fitting import GridFitter, GridFitterConfig, TimingFitResult
from ensomi_model.timing.rendering.dense_timing_v2 import render_dense_timing_v2
from ensomi_model.timing.schema import FittedTimingGrid, FrameTimingPrediction
...
def _stacked_control_teacher_8s(output: Any, *, batch_size: int, slice_count: int) -> tuple[torch.Tensor, torch.Tensor]:
    ...
    if int(value_pred.shape[2]) == 1:
        ...
        from ensomi_model.features.control_v3_targets import VALUE_FEATURE_NAMES
