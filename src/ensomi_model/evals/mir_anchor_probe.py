...
from ensomi_model.data.beatmap_index import load_index
...
from ensomi_model.features.mir_backbone import (
    MIRBackboneConfig,
    MIRProbeFeatures,
    build_mir_backbone,
    mir_probe_features,
)
from ensomi_model.osu_core.hitobjects import ManiaHitObject, parse_mania_hit_objects
...
def run_mir_anchor_probe(
    *,
    ...
    from ensomi_model.evals.mir_anchor_model import MirAnchorProbe, MirAnchorProbeConfig
...
def _score_song_batch(
    ...
    *,
    ...
    from ensomi_model.evals.mir_anchor_model import triangular_support_log_scores
