...
from ensomi_model.models.mapper.v2_1.replay import MapperReplayState
from ensomi_model.models.mapper.v2_1.tokenizer import MAPPER_DENSITY_FRAMES
...
def _export_rollout_outputs_v2_1(
    *,
    ...
    if render_reamber_dir is None:
        return result
    try:
        from ensomi_model.evals.mapper_render_reamber import render_named_spans
