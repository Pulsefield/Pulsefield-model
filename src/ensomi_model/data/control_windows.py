...
from ensomi_model.features.control_v3_targets import CONFIDENCE_FEATURE_NAMES
from ensomi_model.features.control_v3_targets import DEFAULT_TIMESERIES_PATH as DEFAULT_CONTROL_V3_TIMESERIES_PATH
...
class ControlWindowDataset(Dataset):
    ...
    def _default_load_control_v3_target_window(self, record: ControlWindowRecord) -> Any:
        from ensomi_model.features.control_v3_targets import slice_control_v3_target_window
    ...
    def _default_load_ln_change_n_eff_target_window(self, record: ControlWindowRecord) -> Any:
        from ensomi_model.features.control_v3_targets import slice_ln_change_n_eff_target_window
...
def _audio_frame_count_20ms(audio_path: Path) -> int:
    ...
    from ensomi_model.features.mel import DEFAULT_STAGE2_MEL_CONFIG
...
def _default_control_v3_rows(timeseries_path: str | Path, selector: tuple[str, int]) -> pd.DataFrame:
    from ensomi_model.features.control_v3_targets import load_control_v3_timeseries_rows
