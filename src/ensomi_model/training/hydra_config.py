...
def _validate_model_sections(config: Any, *, mapper_kind: str) -> None:
    ...
    from ensomi_model.models.mapper.v2 import MapperV2Config
    from ensomi_model.models.mapper.v2_1 import MapperV21Config, MapperV21LossConfig
    from ensomi_model.training.mapper_common import MapperTuplePhaseBLossConfig
...
def _mapper_run_config_keys(mapper_kind: str) -> frozenset[str]:
    if mapper_kind == "v2":
        from ensomi_model.training.mapper_v2 import RUN_CONFIG_KEYS

        return frozenset(RUN_CONFIG_KEYS)
    if mapper_kind == "v2_1":
        from ensomi_model.training.mapper_v2_1 import RUN_CONFIG_KEYS
