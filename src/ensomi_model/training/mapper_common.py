...
from ensomi_model.data.control_windows import (
...
from ensomi_model.models.mapper.shared import MapperTupleConfig, TupleMapperBase, MapperTupleModelOutput, MapperTupleVocab
...
from ensomi_model.training.common import (
...
from ensomi_model.training.control_demo_global import initialize_global_control_demo_from_control_checkpoint
...
def _compute_control_teacher_8s_for_precompute(
    ...
    *,
    ...
    from ensomi_model.data.mapper_tuple_windows import control_teacher_slice_batch
